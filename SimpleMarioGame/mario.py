...
cactus_img = pygame.image.load("SimpleMarioGame/cactus_bricks.png")
cactus_img_rect = cactus_img.get_rect()
cactus_img_rect.left = 0
fire_img = pygame.image.load("SimpleMarioGame/fire_bricks.png")
...
class Dragon:
    ...
    def __init__(self):
        self.dragon_img = pygame.image.load("SimpleMarioGame/dragon.png")
...
class Flames:
    ...
    def __init__(self):
        self.flames = pygame.image.load("SimpleMarioGame/fireball.png")
