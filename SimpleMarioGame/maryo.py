...
class dragon:
    ...
    def __init__(self):
        self.image = load_image("SimpleMarioGame/dragon.png")
...
class flames:
    ...
    def __init__(self):
        self.image = load_image("SimpleMarioGame/fireball.png")
        self.imagerect = self.image.get_rect()
...
class maryo:
    ...
    def __init__(self):
        self.image = load_image("SimpleMarioGame/maryo.png")
        self.imagerect = self.image.get_rect()
...
fireimage = load_image("SimpleMarioGame/fire_bricks.png")
firerect = fireimage.get_rect()

cactusimage = load_image("SimpleMarioGame/cactus_bricks.png")
cactusrect = cactusimage.get_rect()

startimage = load_image("SimpleMarioGame/start.png")
startimagerect = startimage.get_rect()
startimagerect.centerx = window_width / 2
startimagerect.centery = window_height / 2

endimage = load_image("SimpleMarioGame/end.png")
...
gameover = pygame.mixer.Sound("SimpleMarioGame/mario_dies.wav")
...
while True:
    ...
    while True:  # the main game loop
        ...
        drawtext(
            "Score : %s | Top score : %s | Level : %s"
            % (player.score, topscore, level),
            scorefont,
            Canvas,
            350,
        ...
        if (
            player.imagerect.top <= cactusrect.bottom
            or player.imagerect.bottom >= firerect.top
        ):
            if player.score > topscore:
                topscore = player.score
            break
